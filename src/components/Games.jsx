...
import pnp from "../assets/img/games/pnp.webp";
                ...
                >
                    ...
                    <SplideSlide>
                        <GameCard
                            ...
                            description="Paint N'Powder is a deckbuilding PvP game. You will be building a deck from a constantly replenished  set of cards always available to both players and aim to defeat your opponent with them."
                        />
                    </SplideSlide>
                    <SplideSlide>
                        <GameCard
